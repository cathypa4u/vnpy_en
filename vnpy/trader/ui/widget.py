...
class OrderMonitor(BaseMonitor):
    ...
    def init_ui(self) -> None:
        ...
        self.setToolTip(_("Double-click the cell to cancel the order"))
...
class TradingWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.price_check.setToolTip(_("Set prices to update with market conditions"))
...
class ContractManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle(_("Contract inquiry"))
