...
intptr_t zmq_z85_encode(uchar &str[], const uchar &data[], size_t size); // char -> uchar

// Decode data with Z85 encoding. Returns 0(NULL) if failed
intptr_t zmq_z85_decode(uchar &dest[], const uchar &str[]);              // char -> uchar

// Generate z85-encoded public and private keypair with tweetnacl/libsodium
int zmq_curve_keypair(uchar &z85_public_key[], uchar &z85_secret_key[]); // char -> uchar

// Derive the z85-encoded public key from the z85-encoded secret key
int zmq_curve_public(uchar &z85_public_key[], const uchar &z85_secret_key[]); // char -> uchar
#import
//+------------------------------------------------------------------+
