...
class RecorderEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine) -> None:
        ...
        self.filter_dt: datetime = datetime.now(DB_TZ)      # Timestamp for filtering Tick data
        self.filter_window: int = 60                        # Time window for filtering Tick data, default 60 seconds
        self.filter_delta: timedelta                        # Time delta object for filtering Tick data
    ...
    def add_bar_recording(self, vt_symbol: str) -> None:
        ...
        self.write_log(f"Added Bar Recording successfully: {vt_symbol}")
    ...
    def add_tick_recording(self, vt_symbol: str) -> None:
        ...
        self.write_log(f"Added Tick Recording successfully: {vt_symbol}")
    ...
    def remove_bar_recording(self, vt_symbol: str) -> None:
        ...
        self.write_log(f"Removed Bar Recording successfully: {vt_symbol}")
