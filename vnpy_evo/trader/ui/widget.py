...
class TradingWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.price_check.setToolTip(_("Set prices and updates with market conditions"))
        ...
        grid: QtWidgets.QGridLayout = QtWidgets.QGridLayout()
        grid.addWidget(BodyLabel(_("Exchange")), 0, 0)
        grid.addWidget(BodyLabel(_("Code")), 1, 0)
        grid.addWidget(BodyLabel(_("Name")), 2, 0)
        grid.addWidget(BodyLabel(_("Direction")), 3, 0)
        grid.addWidget(BodyLabel(_("Open flat")), 4, 0)
        grid.addWidget(BodyLabel(_("Type")), 5, 0)
        grid.addWidget(BodyLabel(_("Price")), 6, 0)
        grid.addWidget(BodyLabel(_("Quantity")), 7, 0)
        grid.addWidget(BodyLabel("Value"), 8, 0)
        grid.addWidget(BodyLabel(_("Interface")), 9, 0)
    ...
    def send_order(self) -> None:
        ...
        symbol: str = str(self.symbol_line.text())
        if not symbol:
            QtWidgets.QMessageBox.critical(self, _("Delegation failed"), _("Please enter the contract code"))
            return

        volume_text: str = str(self.volume_line.text())
        if not volume_text:
            QtWidgets.QMessageBox.critical(self, _("Delegation failed"), _("Please enter the number of delegations"))
            return
...
class GlobalDialog(MessageBoxBase):
    ...
    def update_setting(self) -> None:
        ...
        QtWidgets.QMessageBox.information(
            self,
            _("Notice"),
            _("Modification of global configuration needs to be restarted before taking effect!"),
