...
class RpcGateway(BaseGateway):
    ...
    default_setting: dict[str, str] = {
        "Actively request address": "tcp://127.0.0.1:2014",
    ...
    def connect(self, setting: dict) -> None:
        ...
        req_address: str = setting["Actively request address"]
        pub_address: str = setting["Push subscription address"]

        self.client.subscribe_topic("")
        self.client.start(req_address, pub_address)

        self.write_log("The server connection is successful and the initial query starts")
    ...
    def query_all(self) -> None:
        ...
        self.write_log("Contract information query successful")
        ...
        self.write_log("Fund information query successful")
        ...
        for order in orders:
            ...
            order.__post_init__()
            self.on_order(order)
        self.write_log("Commission information query successful")
        ...
        for trade in trades:
            ...
            trade.__post_init__()
            self.on_trade(trade)
        self.write_log("Transaction information query successful")
