...
class PaperManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("Simulated trading")
        ...
        interval_spin.setSuffix("Second")
        ...
        form.addRow("Transaction slippage of market orders and stop orders", slippage_spin)
        form.addRow("Calculation frequency of profit and loss of simulated trading positions", interval_spin)
        form.addRow("Use the current market price to match immediately after placing an order", instant_check)
