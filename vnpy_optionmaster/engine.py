...
PRICING_MODELS: dict = {
    "Black-76 European Futures Options": black_76,
    "Black-Scholes European Stock Options": black_scholes,
    "Binary Tree American Futures Options": binomial_tree
}
...
class OptionRiskEngine:
    ...
    def __init__(self, option_engine: OptionEngine) -> None:
        ...
        #Transaction and position ratio risk control
        self.trade_volume: int = 0
        self.net_pos: int = 0

        #Order Cancellation vs. Risk Control
        self.all_orderids: set[str] = set()
        self.cancel_orderids: set[str] = set()

        #Timing operation parameters
        self.timer_count: int = 0
