...
class AlgoDirectionCombo(QtWidgets.QComboBox):
    ...
    def get_value(self) -> dict[str, bool]:
        """"""
        if self.currentText() == "Two-way":
            value: dict = {
                "long_allowed": True,
                "short_allowed": True
            }
        elif self.currentText() == "Go long":
            value = {
                "long_allowed": True,
                "short_allowed": False
            }
...
class ElectronicEyeMonitor(QtWidgets.QTableWidget):
    ...
    def init_ui(self) -> None:
        ...
        put_labels.reverse()
        labels: list = call_labels + ["Exercise price"] + put_labels
...
class ElectronicEyeManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("Options electronic eye")
        ...
        stop_pricing_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Stop pricing")
        stop_pricing_button.clicked.connect(self.stop_pricing_for_all)

        stop_trading_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Stop trading")
        ...
        volatility_spread_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Set up")
        ...
        grid.addWidget(QLabel("Maximum commission"), 4, 0)
...
class PricingVolatilityManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        for chain_symbol in self.chain_symbols:
            ...
            button_fit: QtWidgets.QPushButton = QtWidgets.QPushButton("Fitting")
