...
class OptionVolatilityChart(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.impv_chart.setLabel("bottom", "Exercise price")
...
class ScenarioAnalysisChart(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.ax.set_xlabel("Price increase or decrease %")
        self.ax.set_ylabel("Volatility up or down %")
        self.ax.set_zlabel("Profit and loss")

        # Set layout
        hbox1: QtWidgets.QHBoxLayout = QtWidgets.QHBoxLayout()
        hbox1.addWidget(QtWidgets.QLabel("Target data"))
        hbox1.addWidget(self.target_combo)
        hbox1.addWidget(QtWidgets.QLabel("Time decay"))
        hbox1.addWidget(self.time_change_spin)
        hbox1.addStretch()

        hbox2: QtWidgets.QHBoxLayout = QtWidgets.QHBoxLayout()
        hbox2.addWidget(QtWidgets.QLabel("Price changes"))
        hbox2.addWidget(self.price_change_spin)
        hbox2.addWidget(QtWidgets.QLabel("Volatility changes"))
    ...
    def run_analysis(self) -> None:
        ...
        for underlying in portfolio.underlyings.values():
            if not underlying.mid_price:
                QtWidgets.QMessageBox.warning(
                    ...
                    f"The current mid-price of the underlying {underlying.symbol} is {underlying.mid_price}",
        ...
        for impv_change in impv_changes:
            ...
            for price_change in price_changes:
                ...
                for option in portfolio.options.values():
                    ...
                    #Add check for option.tick is None
        ...
        # Plot chart
        if target_name == "Profit and loss":
