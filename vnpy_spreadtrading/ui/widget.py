...
class SpreadAlgoMonitor(BaseMonitor):
    ...
    headers: dict = {
        ...
        "payup": {"display": "Payup", "cell": BaseCell, "update": False},
        "volume": {"display": "Volume", "cell": BaseCell, "update": False},
        "traded_volume": {"display": "Traded Volume", "cell": BaseCell, "update": True},
        "traded_price": {"display": "Average Traded Price", "cell": BaseCell, "update": True},
    ...
    def init_ui(self) -> None:
        ...
        self.setToolTip("Double click cell to stop algorithm")
...
class SpreadAlgoWidget(QtWidgets.QFrame):
    ...
    def init_ui(self) -> None:
        ...
        add_spread_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Create Spread")
        add_spread_button.clicked.connect(self.add_spread)

        remove_spread_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Remove Spread")
        ...
        form.addRow("Payup", self.payup_line)
...
class SpreadRemoveDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("Remove Spread")
...
class SpreadDataDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        ...
        button_add: QtWidgets.QPushButton = QtWidgets.QPushButton("Create Spread")
        ...
        grid.addWidget(Label("Active Leg Code"), 1, 0)
        ...
        grid.addWidget(Label("Contract Code"), 4, 1)
        grid.addWidget(Label("Trading Direction"), 4, 2)
        grid.addWidget(Label("Trading Multiplier"), 4, 3)
    ...
    def add_spread(self) -> None:
        ...
        if not self.check_formula(price_formula):
            QtWidgets.QMessageBox.warning(
                self,
                "Creation Failed",
                "Please enter correct calculation formula",
                QtWidgets.QMessageBox.Ok
            )
            return
        ...
        if len(leg_settings) < 2:
            QtWidgets.QMessageBox.warning(
                self,
                "Creation Failed",
                "A spread requires at least 2 legs",
                QtWidgets.QMessageBox.Ok
            )
            return
        ...
        if active_symbol not in leg_settings:
            QtWidgets.QMessageBox.warning(
                self,
                "Creation Failed",
                "Active Leg Code not found in any leg",
                QtWidgets.QMessageBox.Ok
            )
            return
