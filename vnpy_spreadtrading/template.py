...
class SpreadAlgoTemplate:
    ...
    def __init__(
        ...
        self.traded: float = 0                  # Traded Volume (Net)
        self.traded_volume: float = 0           # Traded Volume (Absolute)
        self.traded_price: float = 0            # Traded Price
        self.stopped: bool = False              # If algorithm has been stopped by user
    ...
    def is_hedge_finished(self) -> bool:
        """Check if current legs are balanced"""
    ...
    def stop(self) -> None:
        ...
        self.write_log("Algorithm Stopping")
        self.stopped = True
    ...
    def update_trade(self, trade: TradeData) -> None:
        ...
        msg: str = f"Order Traded [{trade.vt_orderid}], {trade.vt_symbol}, {trade.direction.value}, {trade.volume}@{trade.price}"
        self.write_log(msg)
    ...
    def update_order(self, order: OrderData) -> None:
        ...
        # If stopping task, check if algorithm can be stopped
        self.check_algo_cancelled()
    ...
    def send_order(
        ...
        """"""
        # If already in stop task, prohibit active leg from submitting orders
        ...
        # Check if price exceeds limit up/down
        ...
        msg: str = "Submitted Order [{}]，{}，{}，{}@{}".format(
            "|".join(vt_orderids),
            vt_symbol,
            direction.value,
            volume,
